...
import OpenAI from 'openai-api'; // used only in summarizing lengthy text
import fs from 'fs'
...
app.post("/summarize", async (req, res) => {
  ...
  */
  ...
  const hasText = req.body.prompt.includes(data.choices[0].text)
  return res.status(200).send({hasText, data})
})
